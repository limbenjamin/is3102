 ...
 */
@Entity
public class GoodsReceiptDocumentDetail implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GoodsReceiptDocumentDetail)) {
            return false;
        }
        GoodsReceiptDocumentDetail other = (GoodsReceiptDocumentDetail) object;
